...
;; Emacsのバージョンが古い場合は、Color-themeを使うため、ロードパスに通す
...
(if (< emacs-major-version 24)     
    ;; Emacsのバージョンが古い場合はColor-themeを使う
    (when (require 'color-theme nil t)
      ;; テーマを読み込むための設定
      (color-theme-initialize)
      ;; テーマをholderに変更
      (color-theme-hober))
  (when (>= emacs-major-version 24) ;; 複文を使いたいがためにむりやりwhenを使う
  ;; http://d.hatena.ne.jp/syohex/20121211/1355231365 を利用
    (deftheme molokai
      "Molokai color theme")
